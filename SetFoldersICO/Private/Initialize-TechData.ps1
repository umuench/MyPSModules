function Initialize-TechData {
    <#
    .SYNOPSIS
        Initialisiert die Technologie-Definitionen und benutzerdefinierte Erweiterungstabelle.
    .DESCRIPTION
        Befuellt $script:TechDefinitions mit allen integrierten Technologien und
        setzt $script:CustomTechDefinitions als leere Erweiterungstabelle zurueck.
